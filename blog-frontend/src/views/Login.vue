...
<template>
  ...
  <el-container>
    <el-header height="380px" style="background-color: lightblue; display: flex; flex-direction: column; align-items: center; justify-content: center;">
      <!-- width="1500" -->
      <img class="mlogo" src="../assets/flyhippo.png" alt="" style="width: 200px; height: 200px;">
      <div class="logo">
        <h1>FlyingHippo的博客</h1>
      </div>
    </el-header>
    <el-main>
